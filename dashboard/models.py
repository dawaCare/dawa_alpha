...
class Outpatient(models.Model):
    visit_date = models.CharField(max_length=100, blank=True, null=True)
    ...
    reminder_schedule_1_date = models.CharField(max_length=200, blank=True, null=True)
    ...
    name_of_center = models.CharField(max_length=100, blank=True, null=True)
    ...
    medication_1 = models.CharField(max_length=100, blank=True, null=True)
    medication_2 = models.CharField(max_length=100, blank=True, null=True)
    medication_3 = models.CharField(max_length=100, blank=True, null=True)
    ...
    reminder_frequency = models.CharField(max_length=300, blank=True,  null=True)
